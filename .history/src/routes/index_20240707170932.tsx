...
function IndexPage() {
  return (
    <>
      ...
      <div className="px-4 md:px-10 lg:13 xl:px-20 2xl:px-24 flex flex-col gap-20 mb-28">
          ...
          <div className="mt-[30px]">
            <div className="flex gap-5">
              {newArrivals.map((chair) => (
                <div
                  key={chair.name}
                  className="flex-1 h-[294px] py-10 px-2.5 flex flex-col gap-[30px]"
                >
                  <div className="flex items-center bg-miscellaneous">
                    <img
                      src={chair.image}
