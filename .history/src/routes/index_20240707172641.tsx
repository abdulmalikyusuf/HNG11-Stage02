...
function IndexPage() {
  return (
    <>
      <div className="flex flex-col lg:flex-row items-center gap-5 lg:gap-24 bg-[#F5F5F5] p-2 lg:px-[100px] lg:py-13">
        <div className="flex flex-col gap-5 lg:gap-24">
          <div className="text-32 lg:text-6xl font-bold">
      ...
      <div className="px-4 md:px-10 lg:13 xl:px-20 2xl:px-24 flex flex-col gap-20 mb-28 overflow-clip">
        <div className="py-[88px]">
          <div className="md:grid grid-cols-2 lg:grid-rows-2 items-stretch gap-6 lg:gap-x-5 lg:gap-y-6">
        ...
        <div className="lg:px-5 bg-miscellaneous max-lg:border-t border-primary max-lg:pt-6">
          <div className="flex flex-col-reverse lg:flex-row items-center gap-16">
            <div className="flex-1 text-primary-label">
              ...
              <Link
                to=""
                className="mt-[30px] w-fit text-xs lg:text-base font-medium text-primary border-b border-primary inline-flex items-center gap-1"
              >
                Shop Now{" "}
                <span className="">
                  <svg
            ...
            <div className="text-2xl text-left font-bold text-primary-label mb-9 lg:hidden">
              Unparalled Comfort
            </div>
          </div>
        </div>
