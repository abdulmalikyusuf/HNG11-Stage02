...
function Header() {
  return (
    <header
      className={cn(
        "h-[46px] md:h-[68px] relative flex items-center justify-between px-4 md:px-[52px]",
        "bg-white border-transparent text-black-900 [--logo-fill:#121212]"
      )}
    >
      <div className="flex items-center justify-center gap-3 md:gap-6">
        ...
        <Link to="/" className="w-[114px] md:w-[156px] h-[22px] md:h-[30px]">
          <span className=""></span>
        </Link>
      </div>
      <div className="z-[1] hidden md:flex justify-center">
