...
const Checkbox = React.forwardRef<HTMLInputElement, CheckboxProps>(
	({ variant, roundness, className, ...props }, ref) => (
		<CheckboxPrimitive.Root ref={ref} className={cn(variants({ variant, roundness }), className)} {...props}>
			<CheckboxPrimitive.Indicator className={cn("size-full rounded-[var(--indicator-size)] bg-black-900")} />
